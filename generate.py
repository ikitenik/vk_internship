    ...
    for i in range(days_cnt):
        ...
        with open(filepath, 'w', newline='') as out:
            ...
            for _ in range(events_cnt):
                ...
                action_time = current_dt + datetime.timedelta(seconds=random.randrange(0, 60*60*24))
                data.append({"email": email, "action": action, "dt": action_time})
